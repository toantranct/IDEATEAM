    ...
    e.DEFAULTS = {
        ...
        e.prototype.createButtonToolbar = function() {
            ...
            this.$btnToolbar = a('<div class="btn-toolbar" />'),
                ...
                this.$dropdownBtn = a('<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">Lọc <span class="caret"></span></button>'),
                ...
                this.options.addFocusBtn && (this.$focusGroup = a('<div class="btn-group focus-btn-group" />'),
                    this.$focusBtn = a('<button class="btn btn-default">Tập trung</button>'),
                ...
                this.options.addDisplayAllBtn && (this.$displayAllBtn = a('<button class="btn btn-default">Hiển thị tất cả</button>'),
